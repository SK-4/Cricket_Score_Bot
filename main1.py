...
API_TOKEN = "5485758260:AAHYUXf_sZQXK8DCLizCZ1PhI1nWaG228Gc"
...
def batsman_data(r):
    bat=[]
    for batsmen in r['livePerformance']['batsmen']:
        bat.append(batsmen['player']['battingName']+'     '+str(batsmen['runs'])+'('+str(batsmen['balls'])+')')
    return bat

def bowler_data(r):
    a=[]
    for bowler in r['livePerformance']['bowlers']:
            ...
            if r['recentBallCommentary']:
                ...
                if recent_ball['oversActual'] not in cache:
                    ...
                    if four or six or wicket:
                        ...
                        #print(recent)
                        await bot.send_message(989998291,recent) # your chat id
                    if str(recent_ball['oversActual']).find('.6')!=-1:
                        ...
                        await bot.send_message(989998291,output)   #your chat id
                        #print(output)
                        time.sleep(30)
